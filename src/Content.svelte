...
<style>
    ...
    .item {
        ...
        border-radius: 1.2vw 3vw 3vw 1.2vw;
    ...
    .role-r2 {
        width: 100%;
        height: 50%;
        border-radius: 1.2vw 3vw 0 0;
        display: flex;
        align-items: center;
        justify-content: center;
        border-bottom: 0.7vw solid #3b5998;
        box-sizing: border-box;
    }
    ...
    .c {
        ...
        align-items: center;
        justify-content: center;
        border-right: 0.35vw solid #3b5998;
        box-sizing: border-box;
    }
    ...
    .n-rr {
        ...
        align-items: center;
        justify-content: center;
        border-left: 0.35vw solid #3b5998;
        box-sizing: border-box;
    }
